...
// El GTypeName es global al proceso de GNOME Shell, no al archivo: todas las
// extensiones corren en el mismo contexto de GJS y comparten un unico registro
// de tipos GObject. Este archivo es una copia del de mactahoe-tweaks@son.local,
// asi que el nombre TIENE que ser distinto del suyo. Si los dos registran el
// mismo, la extension que cargue segunda tira "Type name ... is already
// registered" al importar el modulo y no llega a correr ni enable().
export const CornerEffect = GObject.registerClass({
    GTypeName: 'MacosDockCornerEffect',
